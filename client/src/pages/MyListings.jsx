...
const MyListings = () => {
  ...
  const currency = import.meta.env.VITE || '$'
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8'>
       ...
       bg-white rounded-xl border border-gray-200'>
        {[
          ...
          <div onClick={() => item.label === "Available" && setShowWithdrawal(true)}
            ...
            <span className='text-sl font-medium text-gray-700'>
              {currency}
      ...
      {userListings.length === 0 ?
        (
          ...
          justify-center mx-auto mb-4'>
            ...
            <h3 className='text-xl font-medium text-gray-800 mb-2'>No listing yet
            </h3>
            <p className='text-gray-600 mb-6'>Start by creating your first listing</p>
            <button onClick={() => navigate("/create-listing")}
              className='bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2
            rounded-lg font-medium'> Create First Listing
            </button>
          </div>
        )
        :
                  ...
                  <div className='flex items-start gap-4 justify-between mb-4'>
                    ...
                    <div className='flex-1'>
                      <div className='flex justify-between items-start'>
                        <h3 className='text-lg font-semibold text-gray-800'>{listing.
                          title}</h3>
                  ...
                  <div className='space-y-4'>
                    <div className='grid grid-cols-2 gap-2 text-sm'>
                      ...
                      {getStatusColor(listing.status)}`}>
                        {getStatusColor(listing.status)}{""}<span className={`flex items-center justify-end gap-1 ${getStatusColor(listing.status)}`}></span>
                      </span>
                      <div className='flex items-center space-x-2'>
      ...
      {showCredentialSubmission && (
        <CredentialSubmission listing={showCredentialSubmission} onClose={() =>
